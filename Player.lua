...
function Player:render()
    ...
    if self.gameState == "victory" then
        ...
        love.graphics.printf("Victory!", VIRTUAL_WIDTH / 8, VIRTUAL_HEIGHT / 4, VIRTUAL_WIDTH, "center")
    end
...
function Player:checkFlagCollision()
    if self.map:collides(self.map:tileAt(self.x - 1, self.y)) and self.map:tileAt(self.x - 1, self.y).id == FLAG_BOTTOM or
        self.map:collides(self.map:tileAt(self.x + self.width, self.y + self.height - 1)) and 
        self.map:tileAt(self.x + self.width, self.y + self.height - 1).id == FLAG_BOTTOM or
        self.map:collides(self.map:tileAt(self.x - 1, self.y)) and self.map:tileAt(self.x - 1, self.y).id == FLAG_MIDDLE or
        self.map:collides(self.map:tileAt(self.x + self.width, self.y + self.height - 1)) and 
        self.map:tileAt(self.x + self.width, self.y + self.height - 1).id == FLAG_MIDDLE or
        self.map:collides(self.map:tileAt(self.x - 1, self.y)) and self.map:tileAt(self.x - 1, self.y).id == FLAG_TOP or
        self.map:collides(self.map:tileAt(self.x + self.width, self.y + self.height - 1)) and 
        self.map:tileAt(self.x + self.width, self.y + self.height - 1).id == FLAG_TOP then
